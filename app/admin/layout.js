                              ...
                              >
                                ...
                                <div className="min-w-0">
                                  ...
                                  <p className="text-[9px] text-slate-400 flex items-center gap-1">
                                    <Clock size={10} />
                                    {new Date(notif.created_at_iso || notif.created_at).toLocaleString('en-GB', { day: 'numeric', month: 'short', hour: '2-digit', minute: '2-digit', hour12: true, timeZone: 'Europe/London' })}
                                  </p>
                                </div>
                              </Link>
                            ))
                            ...
                            blogActivity.map((activity, idx) => (
                              ...
                              >
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  <p className="text-[9px] text-slate-400 flex items-center gap-1">
                                    <Clock size={10} />
                                    {new Date(activity.created_at_iso || activity.created_at).toLocaleString('en-GB', { day: 'numeric', month: 'short', hour: '2-digit', minute: '2-digit', hour12: true, timeZone: 'Europe/London' })}
                                  </p>
                                </div>
                              </Link>
                            ))
